...
DATABASES = {
    'default': {
        ...
        'HOST': 'postgres',  # nama container database di docker-compose
        'PORT': '5432',
    }
}
...
LOGIN_URL = '/login/'  # Ubah sesuai URL login Anda
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Tambahkan jika static files ada di root
]
